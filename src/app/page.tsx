...
export default function Home() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setHottestProduct(hottest[0] || all[0]);
        setPopularProducts(popular.slice(0, 2));
  ...
  return (
    <main style={{ minHeight: "100vh", padding: "1.5rem", background: "var(--background)" }}>
          ...
          <section style={{ 
            ...
            overflow: "hidden"
             ...
             <div style={{ display: "flex", gap: "0.5rem", marginBottom: "1rem" }}>
                <span style={{ padding: "0.3rem 0.8rem", background: "rgba(99, 102, 241, 0.1)", color: "var(--primary)", borderRadius: "100px", fontSize: "0.7rem", fontWeight: 700 }}>POPULAR</span>
             </div>
             <h3 style={{ fontSize: "1.2rem", fontWeight: 800 }}>Listening Has <br /> Been Released</h3>
             <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginTop: "1rem" }}>
                ...
                <span style={{ fontSize: "0.8rem", color: "var(--muted)", fontWeight: 600 }}>4.7 Rating</span>
             </div>
             {/* Decorative element */}
             <div style={{ position: "absolute", right: "-20px", bottom: "-20px", width: "100px", height: "100px", background: "var(--secondary)", borderRadius: "50%", zIndex: 0 }}></div>
          </section>

        </div>
      </div>

      {/* Categories Grid (Outside main dashboard for a scrollable experience) */}
